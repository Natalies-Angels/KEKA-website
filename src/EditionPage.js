    ...
    <div>
      ...
      <div className="edition-card-section" id="jicho">
        <div className="edition-card">
          <div className="edition-card-image">
            <img src="/1.png" alt="Edition Image" />
          </div>
          <div className="edition-card-content" id='jicho'>
            <h2>Jicho</h2>
            <br />
            <p>
      ...
      <div className="edition-card-section" id="domo">
        <div className="edition-card">
          ...
          <div className="edition-card-image">
            <img src="/Square Pillow Mockup.png" alt="Edition Image" />
          </div>
        </div>
      </div>
      ...
      <div className="edition-card-section" id="skio">
        <div className="edition-card">
          <div className="edition-card-image">
            <img src="/All 3.png" alt="Edition Image" />
          </div>
          <div className="edition-card-content">
            <h2>Skio</h2>
            <br />
